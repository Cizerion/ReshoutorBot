...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="reshoutor" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.first_bot.resh_bot.Main %CMD_LINE_ARGS%
